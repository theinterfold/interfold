...
const FILES: Record<string, Role> = {
  ...
  'packages/interfold-contracts/deploy/protocol/mainnet-protocol.secure-crisp.upgrade.governance.safe-builder.json': 'record',
  'packages/interfold-contracts/deploy/protocol/mainnet-protocol.secure-crisp.upgrade.json': 'record',
  'packages/interfold-contracts/deploy/protocol/mainnet-protocol.secure-crisp.upgrade.safe.json': 'record',
