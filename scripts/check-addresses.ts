...
const FILES: Record<string, Role> = {
  ...
  'docs/pages/operate/index.mdx': 'consumer',
  'docs/pages/operate/running.mdx': 'consumer',
  'docs/pages/operate/rpc-endpoints.mdx': 'consumer',
  'docs/pages/build/tutorials/deploy-to-testnet.mdx': 'consumer',
  'docs/pages/reference/contracts.mdx': 'consumer',
