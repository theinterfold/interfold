...
// (MetaMask) OR one of the anvil dev keys — the submission MUST be signed by the DAO's
...
/** Anvil `test test ... junk` accounts 6, 7, 8 (the default DAOs), 9 and 0 (1–5 are the ciphernodes). */
export const DEV_KEYS: { label: string; key: `0x${string}` }[] = [
  { label: 'anvil #6 (DAO 0)', key: '0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e' },
  { label: 'anvil #7 (DAO 1)', key: '0x4bbbf85ce3377467afe5d46f804f221813b2bb87f24d81f60f1fcdbf7cbf4356' },
  { label: 'anvil #8 (DAO 2)', key: '0xdbda1821b80551c9d65939329250298aa3472ba22feea921c0cf5d620ea67b97' },
