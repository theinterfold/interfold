...
// (MetaMask) OR one of the anvil dev keys — the bid MUST be signed by the bidder's own key
// because the contract binds the proven address to `msg.sender`.
...
/** Anvil `test test ... junk` accounts 6–9 and 0 — the dev balance snapshot's bidders (1–5 are the ciphernodes). */
export const DEV_KEYS: { label: string; key: `0x${string}` }[] = [
  { label: 'anvil #6', key: '0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e' },
  { label: 'anvil #7', key: '0x4bbbf85ce3377467afe5d46f804f221813b2bb87f24d81f60f1fcdbf7cbf4356' },
