...
export type CircuitBundle = Record<LegName, CompiledCircuit>
...
export const requireCircuits = (): CircuitBundle => {
  if (!registered) {
    throw new Error('No CKKS auction circuits registered. Load the three compiled circuits and call setCircuits() before proving.')
  }
  return registered
}
