...
import { MatchingApi, setCircuits } from '@ckks-matching/sdk'
import type { CircuitBundle } from '@ckks-matching/sdk'
import { CIRCUIT_NAMES } from '@ckks-matching/sdk'

export const API_URL = import.meta.env.VITE_MATCHING_API ?? 'http://127.0.0.1:8093'
export const api = new MatchingApi(API_URL)
