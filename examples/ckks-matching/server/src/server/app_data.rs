...
use super::{
    database::SledDB,
    repo::{MatchingE3Repository, RoundIndexRepository},
};
...
impl AppData {
    ...
    pub fn e3(&self, e3_id: impl ToString) -> MatchingE3Repository<SledDB> {
        MatchingE3Repository::new(self.db.clone(), e3_id)
    }
