...
// (MetaMask) OR one of the anvil dev keys — the application MUST be signed by the applicant's
...
/** Anvil `test test ... junk` accounts 6–9 and 0 — the dev issuer snapshot's applicants (1–5 are the ciphernodes). */
