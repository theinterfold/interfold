...
import { FedAvgApi, setCircuits } from '@ckks-fedavg/sdk'
import type { CircuitBundle } from '@ckks-fedavg/sdk'
import { CIRCUIT_NAMES } from '@ckks-fedavg/sdk'

export const API_URL = import.meta.env.VITE_FEDAVG_API ?? 'http://127.0.0.1:8095'
export const api = new FedAvgApi(API_URL)
