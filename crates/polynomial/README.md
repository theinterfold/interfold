...
```toml
[dependencies]
polynomial = { git = "https://github.com/theinterfold/interfold", path = "crates/polynomial" }
```
...
```toml
[dependencies]
polynomial = { git = "https://github.com/theinterfold/interfold", path = "crates/polynomial", features = ["serde"] }
```
