...
/// their stable operation ID. The newest HLC context wins.
///
...
/// after `EffectsEnabled` — is dropped. Keys are cleared per E3 on terminal
/// events, which bounds growth to live E3s.
...
mod tests {
    ...
    use e3_events::{
        ...
        EventConstructorWithTimestamp, EventSource, InterfoldEvent, LbfvPkAggregationProofRequest,
        LbfvPkGenerationProofRequest, PartyProofsToVerify, PkBfvProofRequest, Proof, ProofPayload,
        RlkAggregationProofRequest, RlkGenerationProofRequest, SignedProofPayload, Unsequenced,
