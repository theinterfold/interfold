...
//! shares → ciphertext → decryption share → circuit witnesses.
//!
//! Run: `cargo run --release -p e3-zk-helpers --example gen_ckks_c6_prover [-- --param-set 0|2|3]`
...
//! The witness is at LEVEL 0 (fresh ciphertext, full modulus chain).
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Party 1 (x=1): row 0 shares, then its real decryption share.
