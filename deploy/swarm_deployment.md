...
export SEPOLIA_SLASHING_MANAGER_ADDRESS=0x...
export SEPOLIA_INTERFOLD_DEPLOY_BLOCK=<block>
export SEPOLIA_CIPHERNODE_REGISTRY_DEPLOY_BLOCK=<block>
export SEPOLIA_BONDING_REGISTRY_DEPLOY_BLOCK=<block>
export SEPOLIA_SLASHING_MANAGER_DEPLOY_BLOCK=<block>
```
