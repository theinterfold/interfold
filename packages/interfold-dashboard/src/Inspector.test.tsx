...
import { compactE3Id, pollMetaFor } from './lib/pollMeta'
...
test('compacts long E3 IDs without changing short IDs', () => {
  assert.equal(compactE3Id(42n), 'E3-0042')
  assert.equal(compactE3Id(LIVE_FAILED_E3), 'E3-18458939…782976')
  assert.equal(pollMetaFor(LIVE_FAILED_E3).question, 'Encrypted poll E3-18458939…782976')
})
...
test('renders a failed E3 as failed instead of complete', () => {
  ...
  assert.match(html, /E3-18458939…782976/)
