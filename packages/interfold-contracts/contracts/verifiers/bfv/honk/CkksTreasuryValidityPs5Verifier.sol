...
uint256 constant VK_HASH = 0x13b724e55b64a0bb0b4a669a72a3845a3569deba0244204e08190f7721155bff;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x194c4ad3b76882066e7df9d134bd8e5f950cb832edb46735749c5f0270cf3f90
                ),
                y: uint256(
                    0x1402ea5e5b402b827705645b246ec91b1532b7bda2f23b89c9804772aeedc451
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x0dfcbf16d11c450ea621fcba394f2a93e81697cd3e51be0d8c6daca4960f32c7
                ),
                y: uint256(
                    0x0b10df1083a366474c277a62d0e49023e2e59c3af01281b848d4ae29b3179fe9
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x1e72e377d20fa32900e26b4b3f21c19724c41ec12b7e16e03b9010a3e086bb9e
                ),
                y: uint256(
                    0x2aeb946ec4de31988d29b40e127ae37a53e1ba778e6c2fdf45999b84f840850b
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x1733906670e404cbe6750fab29ad81d8e0919df70eb5fd61f5fa0480d7e09af6
                ),
                y: uint256(
                    0x2481651929930fbcc90007dca64c996809b7dec0fcce64cc4239fe510c93ba50
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x1ce6d62bd94a3f85232fb0e22396518d87bca21e8918d495735e026f24bbfe29
                ),
                y: uint256(
                    0x26425f5da081430be5c56f55ef446d6b24abdb18658a0d78a1e39c5443ee046d
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x0326a71e2c33095ca1e59a6f93f9f3f00472173df7b50c431d1398de4242fd04
                ),
                y: uint256(
                    0x248ac8e98c3bc33c8ef1a34e6afdfe18108e9649124e2f72a89376c90dd4f126
                )
            }),
            ...
            qArith: Honk.G1Point({
                x: uint256(
                    0x18f3b04ff79bd4f14114d47210cbed9a7a8e9d264f83813cdaebad28e5ddfbf5
                ),
                y: uint256(
                    0x1ceb29ca4a1803174ea90af403409e8c51e98d0adb99ef15a3316e30ac250a77
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x285a5dd722808188e8de2d69258561b1bcc82b150b8c2facc9f072e5da534508
                ),
                y: uint256(
                    0x113e9456e2a869e14a62b8aaca0a8d0262cf4b0903e6015c4ab5b28af8bff4a8
                )
            }),
            ...
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x1168f00f6ec7ec88d579fcad12de3fd40adf681a9f39d79f404b8b52f2b8c5bf
                ),
                y: uint256(
                    0x2f70e53820a8f5c17e230d38ba965fa164828265f51cc1df5bcf7914a8f978fb
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x25c9d58baee44e07535ccd75c97cbeacbd949753a05cda60d4d076c522c7a838
                ),
                y: uint256(
                    0x127e5be6582b761e31be08bc5f8de7f5a2c28832c928c6c02bf659b5b83510a2
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x2089c9380d6488d77be2af0d0ab407d7f03dbfe28d1a68856525f57d1dd0906f
                ),
                y: uint256(
                    0x11a536f72eee669b8054fd7757bbcfe5acbed5a853053b256c56a9d2ce03078d
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x0aab378c76d8e0e80299a374d950da320b2021680269df71c8307d43851687d7
                ),
                y: uint256(
                    0x22695d1acc7ab4472b043f255cba6fdd96698da097ec556a76caa28ce2a18253
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x21e70769eea9e2e216608d4411350b2a4b8e03682c738d5389bc3aba336430f6
                ),
                y: uint256(
                    0x2d8d07ef9338892a22fa589c4d4d06fa57dee2785c3504d2818e3989b3cb4cd3
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x0de7552e3ece9034c909c7a32173b536f6208e4a614088e0fc376707c068a4ef
                ),
                y: uint256(
                    0x1944bac829b0727fda2bc96fdf0a66009fdf9ef7dd4806c5c052d5e7f0c4ae71
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
            ...
            id1: Honk.G1Point({
                x: uint256(
                    0x292de6c92d39c4eb3305320c8ee924bc676ffd2c4ab8957f6ac22aac303b20d1
                ),
                y: uint256(
                    0x16a3e48acf888b6d4ea41c6bfe2d821a7e50e5d447dfb71b65428b331eb4a40d
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x10149f6e30742f0e6ca1c0587fa3efdc4943fb8153905d2748fc7e8d57cce53c
                ),
                y: uint256(
                    0x157f0bfff8bd0aa4c579e9f1dc1a722be429184ec27886b0b106ca4877e68382
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x15c206081a01be59f2bcfb81cded2bcfd67a95e4bad91fb2d4d50f587085a250
                ),
                y: uint256(
                    0x256fadd77dd3e44dd946bf601c09d70a614c1a63f76d624fba5f71cd9dd1709e
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x24496cd02c915b40c058b5f444d93e532ccaf9f55c4eda44a582d337c9dd59b7
                ),
                y: uint256(
                    0x2a6a7f89df40738cd690c577cd6f1f4462b01efbc2f1a4c6a2ae76a15e08ceb8
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x1d172e7096cf546a2ebbc37ba0d8cf9472ed530b286d906e6957751328d5d233
                ),
                y: uint256(
                    0x18b575aa639ef4a7450d8ab8af692c933eebd820c5ee204590b16a090cd46a95
                )
            })
        });
        return vk;
...
contract CkksTreasuryValidityPs5Verifier is
