...
uint256 constant VK_HASH = 0x2a879aa713f998988fed3476c3dad2aa1300282790681169024156e5c1c6b2d2;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            q4: Honk.G1Point({
                x: uint256(
                    0x1155df78ff423c1e3be3b7b055173fe0518276393667ebed765600059cbe06e9
                ),
                y: uint256(
                    0x152483e8c69f3a2ae8424c9c3a3a9cad55d219998c107c9d1750e3dd23d139a4
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x21aa46af9a29786b015d2e004577de3192dbe3995b20949663a7a7e6a4a365f2
                ),
                y: uint256(
                    0x17e5e3e6c391adaeb24325b96a69b8b914326b334673d95a6b3bc4dd780513d0
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x2341439d0e373efacb5d6fd20110de7f27cfc3f543a0839b23433f3ecdacd050
                ),
                y: uint256(
                    0x2a07f7a5d8e938639f453a9af029f358ef55fe8a32adbea7f25822ae964aced7
                )
            }),
...
contract UserDataEncryptionCkksCt1Ps3Verifier is
