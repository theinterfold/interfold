...
uint256 constant VK_HASH = 0x0abd75cc5e84cbd91bfae1d5664328c2d7f10a8baf661526366a44073ecd88b6;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            q4: Honk.G1Point({
                x: uint256(
                    0x1ab66f9b129f9d8c62ad71e35d1b3731b4d3821ca9f3d57f46f3691998a2d2da
                ),
                y: uint256(
                    0x1089c96975eadefadd1ab09bfa29f48c2f85670d89900a5a6a68dc5394d17da3
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x009c06cafbea6f6568ca9985bc11e5237f289a517951d3c6dc8818540c374081
                ),
                y: uint256(
                    0x27150ed5a4bddfa70a453163cc5f315572acb6e8f0c0ed824fb752b820017495
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x20d0fd2242bd6b7683dcc2b3295c126c8c45f15d57e171f7d4391cbac2db023e
                ),
                y: uint256(
                    0x179af42a6a5f8be899955e45fc2cfaba9ebe311db0eb1ed4b245689fd5c78e05
                )
            }),
...
contract PkGenerationCkksPs5Verifier is
