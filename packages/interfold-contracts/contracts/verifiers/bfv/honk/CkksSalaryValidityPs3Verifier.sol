...
uint256 constant VK_HASH = 0x1ea578b95535ab4f633b665b3a0bedb2dde630ec34a6a2b2725dadab58e234d2;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x22ed83067cce0d080c5db8843a53189ae33ff020c7bdcc30ec51a3b3d999a158
                ),
                y: uint256(
                    0x2df368785602017daa8349208e5f3cad7d2f6e63e837ec94a6d7cc398677712b
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x199a6e1f1052e009401f97caaf2f7167e047adf558a5fd22b14fa6c9c3553788
                ),
                y: uint256(
                    0x1de026ee096a8251f5c3733b81b4126fc256633f93df8ab4b5cfe22c2eccbb73
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x16e3b133df80821e7c7bf0ba11ef6b868378ef0b99358cd64076e1adfaf0c052
                ),
                y: uint256(
                    0x2cf97527ae407f02a9f1a7a8ba10285b40ecbf644da22776a1975cea53dfac13
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x102fc8de4de940211e585d739c1300644e4a31846fce6ea99dc5ee5192fa3df2
                ),
                y: uint256(
                    0x243c482cb41f5e695afef6e6bdfd53e2d65431ea63e773c1d8241991084f70de
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x1e9e4253b8717c9c157e6484da34b16d0f2d939ce396d715e116fef61199c812
                ),
                y: uint256(
                    0x25e90e10aa4a1c39287837432350278b1105caf8239e87c069112f16b14d2041
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x151fabab9bf2b15ea1235d2664c2f2c4863686064c7b99c6ac7ba90219c80978
                ),
                y: uint256(
                    0x0643561f098647a61f9c69d1f8290b7752e82172f19528d42a004e301be50c4e
                )
            }),
            ...
            qArith: Honk.G1Point({
                x: uint256(
                    0x14da72494d9d33cf186360b769effa7db2529fbd4dc6ddaf8e2fccf257cd2a87
                ),
                y: uint256(
                    0x2cc31b7b630a228291b5dfa9805e757ddc5b46022955af6ca41fa2e0fa1a72d8
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x0a0e6833f1d8fb74cddbb37ad5d5c335a74aacd283344c14966c62b59bc5e7cb
                ),
                y: uint256(
                    0x22c08fdf72ff40fd6f506f70c935bc499fd5b8fad1ceb68c0db7a31d863130fe
                )
            }),
            ...
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x007e0b7d43e8bbd27dac1c97b24ca92bf37f025e52addf7062c44fda6f2e815e
                ),
                y: uint256(
                    0x04be39d30fa58f87289f3e68eb52ca238e85fd951fd9aa89a3e26807695b82e3
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x1a775017f49e91395a7556d3fbe2a203fac8c9715ad708434d225967346ceb96
                ),
                y: uint256(
                    0x09397301f35da6043e1279447130649959443bffb1fba4ae299a86f9a5902757
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x2418478ff19a790807545fd0211b72c1f4ecdffb5d0b294568133e022c3a54b2
                ),
                y: uint256(
                    0x12bb216d11553ef7efb5e7cbfc996efcbe9404928d8fe3e236c40de9008966e2
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x063ab4457d444bef51f7199bedc0dc44bef571780dfaafe5d6689a788beb3f86
                ),
                y: uint256(
                    0x27bff442edae7febd2d8dd0f77bb2b858b67da96d0a40b7db8209bb47fce322d
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x1cf41ef316b87d0345f8e5e900d4562b2115d00294fa578255be0a7c1bc83a42
                ),
                y: uint256(
                    0x001a79db006ff10ca4a2d292dc5473396f91968dccd6afa06a20520c321aface
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x27749c7e6364bdf7cc757347d79d11b12ee5fef6aca0b90fd3f9e1f85a83b5b6
                ),
                y: uint256(
                    0x2b9979ac5d8a2ee82fa2c6568976ecfafbbe407a6f2e47ed3734afb3204b3f2c
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
            ...
            id1: Honk.G1Point({
                x: uint256(
                    0x25858186c2816d558b4d71df02e5710bbb606516a667fea822c836080b9db2a4
                ),
                y: uint256(
                    0x1da05c94d8fb504783214eeac164a532b8f49ef3ab976d17d78d0b7b4d2e026f
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x2d19b5168beab5ac2f1c0055f599e394f6ca20b8178ead179175b4cbd2a32b54
                ),
                y: uint256(
                    0x1dcf84def43842c7aadadef5e5f39e4011e537447df9a23b9959862e45b960b6
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x19ba650d597aff3c560b1fd7a4b54eb2665440322ff95d39ac4d109e5d38ddcb
                ),
                y: uint256(
                    0x2e02aedf88927a7306ebbc3e8e210443e62419cc6910bb625d9b492dc2286880
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x2056c9fa285eb62ecd0441b6e439bf6b665e08d0dfacd2d421cd8970fc6772ab
                ),
                y: uint256(
                    0x2868019fd28301ddd443cab7a9eba087e42e52bbec5a18b0cfc2261642e58399
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x11251e5ba466fe09adbb89407d49c3817de1b900941ad8ceb5e9bde22fe0b303
                ),
                y: uint256(
                    0x1de0320a3de4452b49f549334b9aed8ff167fa914181fb8c2b1e41a839a9f28f
                )
            })
        });
        return vk;
...
contract CkksSalaryValidityPs3Verifier is
