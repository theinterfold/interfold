...
uint256 constant VK_HASH = 0x18d69761c6811a08d628a4da77c31ea20c8c3f28d8ef401cb68ed7252ac6e354;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x155f5ea65dc449917f9b3d6d183859d953971c15b1735b3c5ce5365084d46c66
                ),
                y: uint256(
                    0x12106c968476f2f1942884792174ae05baae014580479ca0cbd75f9a380fbd85
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x03288405316e588fb11779ea073047d9966d76191d41c64f8b8cec875da8fee7
                ),
                y: uint256(
                    0x130a0c45a81d425322a7382b691e3d1115c1554d3ce0defeb913e9650d05dff6
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x08189345c1568fceb95576dccf074494880222cd451ca44764ef4d00806bd087
                ),
                y: uint256(
                    0x0908253cadab0c97541c5f8d7373152151744f70867abe517f6a6f03d0993400
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x13063f1eaad8899bb8c83bde65cb321bb08dc91d26c04e1d8c8ae53563853244
                ),
                y: uint256(
                    0x10a31e798485c379fc77274d55f531caa0c961bd6c32158a5910150eb3238cce
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x06819cba4e4bbabfb85d955b959fe297146b64fc95015bd5bdb7c40e759a6490
                ),
                y: uint256(
                    0x10bfff3585370f05e92d1cd0204811f68eda028c318f414eaaf07e5fe1f179f1
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x1fa7bf0684bfcfa0f8656f6e8efd537c0ecc97012b82b4e8b29bd1b1101628fc
                ),
                y: uint256(
                    0x0f27ab564425309cfeef03bd8dfa6747f58307017bac005a9af2c68b5bb67bed
                )
            }),
            ...
            qArith: Honk.G1Point({
                x: uint256(
                    0x0a569922e024e489c15e549724f33db177505bd94ad92b5db3e98e01f8455838
                ),
                y: uint256(
                    0x0a8b2da9383d6bf5a3cfb9dfc2bbcdcda89cd0dcff605c55df77386db2725562
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x0b4778642d9380bacc3e01a8b14b8e0536b518a9173d6d2cb4fce4c0c376d270
                ),
                y: uint256(
                    0x1ebf04750ba26f8adf23fe2643829fe9dd65e7d8e081c62317c286cd4d395262
                )
            }),
            ...
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x2c238f23f15170fb9fa61fccc1e20d0ddaf49f7b106c00d9dd33a831c896c00a
                ),
                y: uint256(
                    0x11dac037186a6c2ca150299a8c0ff4a67968db58ee2be7129def4803e77dd688
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x24d9b22b1ada04948a1f1b55d1eba0f672c76fd07171458ce25a5a07a0788156
                ),
                y: uint256(
                    0x1773c5219a7d63660fc5cc150ec4e0695d92acd9e2442527278d1b396ae29af8
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x02ff53fb43c58160516c30beb3304f1b5818c7c6486033a1a0b02a0367d277cd
                ),
                y: uint256(
                    0x1327515f3bc1261b0d622acff2cb0e6575a84a7aaac50177f45e4ec3ac9ff2c4
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x1582f2b48caf8560549267814dfad043774a78bcd189385f683f9f05926b8a2e
                ),
                y: uint256(
                    0x125504022c83efa216930e5f8986eec7a3a5e8d4799e1cb2941ee7c06841bd7e
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x146df93e3c153c7b0e33b6aed5336d69d15eb62a2582a494a4c84a90fb3271f4
                ),
                y: uint256(
                    0x2ff3480948dbf9c0a76736937a02e24fa7a0a06cd8da647f442bdbcac51f5839
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x052c93b1bf2b8b2ea563e5a960cd9d91ef560c6d439b9ba64cf8d5879f1b48e4
                ),
                y: uint256(
                    0x0ba52c116356f573f571f7544dde692a85e1cef0b068c7e0232b7de7b67a84ba
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
            ...
            id1: Honk.G1Point({
                x: uint256(
                    0x0a323a836e99464af7bce0d8496c73f990d30a1cba7e06a035ca8d0eb2f5a88f
                ),
                y: uint256(
                    0x096840dc60712129c54a0eccaaff10df498ee2cd5ade43fb5322d64c250b1d1a
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x1af8182ec22ad6287ca89eb9a3a851ad90606cea40a634e94056808ef10204d0
                ),
                y: uint256(
                    0x2c8dcdec5c19c8d0463bcc8fe0de2628ee414870217af806a5326c26f48c25cd
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x25c327f21b3e5d95e9b02acac2d7cfd6b9c2ec987ce6160e101b40c69855adc6
                ),
                y: uint256(
                    0x248ac5729907f304346338d0a0afcb0cf8f8c862ed8965369712f59c06b2e70b
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x2537c85e1d738957974f177443fbb79d1e1ab792882cc91deae8041b0ad99b7c
                ),
                y: uint256(
                    0x22c2330828ab7cf9c36d14812613ce06b7ab2abf34c1020de611bc619b4a6854
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x087ee1503b0c58ef7f71d96506f230a7d2fcabdb3b092944e194ba133ab00755
                ),
                y: uint256(
                    0x2347599308cabc0074fdbfa4e4ad082d84f1bf89852caadf2b0ac30a5e13c3a1
                )
            })
        });
        return vk;
...
contract UserDataEncryptionCkksCt0Ps4Verifier is
