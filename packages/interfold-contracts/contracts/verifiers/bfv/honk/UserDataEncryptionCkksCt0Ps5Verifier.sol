...
uint256 constant VK_HASH = 0x0fdfba0a5e09f57b37761e7485c5d4eb0b052c3eb1f323280cf8b7672f853ab7;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x147cd8f37d1e7e06aa38560619e8b1bd5c597d14128e830ab5edc24ce3360433
                ),
                y: uint256(
                    0x0341a7c3d5256885f354a45340299fe5a6c049280a59f4d2fbc56b67493211e7
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x204cb141d89ad2e82c05addc9a359341a8ac2fd818a551da971e4ccb36f1aed6
                ),
                y: uint256(
                    0x1bef01e1ddb638d3fc7d2c440148b48d4d05d922946edc6fcb2357471f71f0d8
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x236ea920e570ee66e165326cd05eec9d18af44fcd4c2539db821f99ec6e2ee42
                ),
                y: uint256(
                    0x095fccb525c4420afc1b43243e0fa474534706843a58d672efeee1bee6596d9c
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x207a4731432ce4fe389790faaf557a4e095413a11a447f7f9d70c697fbb8db89
                ),
                y: uint256(
                    0x2572ec25140792ca69e41add5e6a776f7f5d695f5ac1b4543e3a3426bded8f81
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x2e2e701a5f19afe43323598a062e20de2b5b1a3b2735e219d7199c457a3dd06e
                ),
                y: uint256(
                    0x2958d7db33158241bcd7e1a4e4e2cd5a26f26e93b8430d60c8ce8e1b9fcc1441
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x199d7080fb48e6806f595102cb0831682c35b851b522f43d22b3511034a67367
                ),
                y: uint256(
                    0x1f632b7e27ce9726545d734b3821477be1e882a30f25a74f0eb78fd4c9343e3c
                )
            }),
            ...
            qArith: Honk.G1Point({
                x: uint256(
                    0x29ccf0001764803e583cafb83c89f244d385ba712e5c4fbddae5ee8818521cdb
                ),
                y: uint256(
                    0x0a5d1175489ff4b18ee8f7830924901c5adc936a1e04bc76aa3de47283dae9dd
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x2c15a25e2de466b7a591bec08f694d275f20e8d62587d3372ba7355a64bc3995
                ),
                y: uint256(
                    0x27251091c30eff8b1cffa2974c2391dd6788444479afb5db54e063c1208b843a
                )
            }),
            ...
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x1957c052a14dc89a794bf01922bc66c907d4b603df4744df55433628926d67f1
                ),
                y: uint256(
                    0x260b3bbc745deddb9d459b93ce5861c5b947f1a24fcb5ab1a63f76c05d449a84
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x164ded1f1b8d379753ef81d3a148bb528d0239fe69004ef93881b2bc5cd0ce25
                ),
                y: uint256(
                    0x20f0c468847222eac33d5688ce0d05739b8b200b2b4fda8c771e494f5ae4f6cc
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x2a9c888a7ddd793b9de630f32c7030aa16841f5078106a5e4366cf5a4da271b8
                ),
                y: uint256(
                    0x2f876014ba5fa8d7e6e6c819c5d7b6e5b15241056d42a1600c73e004f86da5ec
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x0265533207672045b7b88834e4ee74cecb6cf7b8ae5af7925f5d8aae257f5dcf
                ),
                y: uint256(
                    0x1682d43e78a798a8fd0ba4d99f3f0ca83aa451e08ea3f7bf9e10c1c5b5c6577f
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x23a568a077135f3b163669be15310da5064a20a6e38557b374bc975de2bd0038
                ),
                y: uint256(
                    0x275c63aef3b53483a8eeeeb169a963a75e018eb82a880a0e693622fa95dc801e
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x2a4f507dcc63da025822ab94fe7ed623e629d78bd7fe98dd00ca6f5eb7b86b59
                ),
                y: uint256(
                    0x20ffd783930cd344eca23fc603a6cebfefda1c4436ae3eee440393f0ecc0d708
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
            ...
            id1: Honk.G1Point({
                x: uint256(
                    0x073430ff160dcc9c4831edfb2177612905e0c457d5dbf3417b2733a17cf2f984
                ),
                y: uint256(
                    0x2f4299423349aa9ef3b7874f96ec7be7d032949d0dd9b7fd25d9bf0fc325f520
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x2d2708317ba1d57f3e15e5be3ee9c68dc7bbdd9e333e06cf62f0d4fd8aa3572b
                ),
                y: uint256(
                    0x2fcac66a2d61be89037beb1d701189704dfd48c58217aee3bb8cf5489717885c
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x1a6259a52e845b66cff4778a66f278503bd1216af7b7abc2e7c495ace32bad5c
                ),
                y: uint256(
                    0x1590ec21109971101fe4e6ce8def81a764625ec88f421515117ed5677d9bd590
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x19fb5a95f4fdcf4c2db68d92184666f0ff7a48fc2699d0595f9c6ae806a2977b
                ),
                y: uint256(
                    0x2df64653cb8d44d178d8ac5db7c12f955813606a194d57cb0f65f3bc5fc65b92
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x298377d4c0af799ca2da38bcb0f92b21690a421d64400f1d1919538a691b49d9
                ),
                y: uint256(
                    0x02d60a2f0257978780707758cb9eaf5922a7235f37d999007b01784d0ea260fb
                )
            })
        });
        return vk;
...
contract UserDataEncryptionCkksCt0Ps5Verifier is
