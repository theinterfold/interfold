...
Running `interfoldup install` will install the latest version of the Interfold CLI. Give `--version`
a release tag to install that release instead. See `interfoldup --help` for more options.
