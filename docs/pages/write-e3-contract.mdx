...
[mockup](https://github.com/theinterfold/interfold/blob/main/packages/interfold-contracts/contracts/test/MockE3Program.sol)
or check out the
[CRISP program implementation](https://github.com/theinterfold/interfold/blob/main/examples/CRISP/packages/crisp-contracts/contracts/CRISPProgram.sol).
