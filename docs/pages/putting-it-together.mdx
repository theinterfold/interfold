...
await InterfoldContract.request(
  ...
  e3ProgramAddress,
  0, // paramSet (0 = insecure dev, 2 = secure production)
...
- **Interfold GitHub Repository**:
  [https://github.com/theinterfold/interfold](https://github.com/theinterfold/interfold)
- **CRISP GitHub Repository**:
  [https://github.com/theinterfold/interfold](https://github.com/theinterfold/interfold/tree/main/examples/CRISP)
