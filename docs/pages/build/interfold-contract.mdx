...
The committee enum that you select fixes `N`, `H`, and `T`. It affects the cost, liveness margin,
and economic security of your E3. Larger supported committees require more coordination and proof
work, so they have a higher fee. Applications cannot choose arbitrary threshold values.
