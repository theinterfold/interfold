...
| `SECURE_THRESHOLD_8192`  | `2`                 | 8192   | 3              | ✅ Full  | Production-equivalent work |
...
request an E3 with `paramSet: 2` but initialise the SDK with `INSECURE_THRESHOLD_512`, the
...
const requestParams = {
  ...
  e3Program: '0x...',
  paramSet: 0, // ParamSet.Insecure512. Use 2 for a secure-8192 E3.
