...
> the faucet runs dry, reach out on the [community Telegram](https://t.me/encaborations).
...
Bond FOLD tokens to meet the license requirement:
...
- Approves the BondingRegistry to spend your FOLD (if needed)
...
This deposits 100 USDC (or fee token units) and mints the equivalent in non-transferable tFOLD
